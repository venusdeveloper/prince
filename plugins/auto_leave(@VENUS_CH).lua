...
When someone invited this bot to a group, the bot then will check if the group is in its moderations (moderation.json). If not, the bot will exit immediately by kicking itself out of that group.
